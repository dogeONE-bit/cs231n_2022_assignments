...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    target_real=torch.ones_like(logits_fake).type(dtype).squeeze()
    target_fake=torch.zeros_like(logits_fake).type(dtype).squeeze()
...
def generator_loss(logits_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    target_fake=torch.ones_like(logits_fake).type(dtype).squeeze()
...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    loss=0.5*(torch.pow(scores_real-1,2)+torch.pow(scores_fake,2)).mean().type(dtype)
...
def ls_generator_loss(scores_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    loss=0.5*torch.pow(scores_fake-1,2).mean().type(dtype)
